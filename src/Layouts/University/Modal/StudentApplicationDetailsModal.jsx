...
export default function StudentApplicationDetailsModal({ application, onClose }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 max-h-96 overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-900">Student Application Details</h2>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
              <span className="text-2xl text-blue-700 font-semibold">{getInitials(application.name)}</span>
            </div>
            <div>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">{application.applicationDate}</p>
            </div>
          </div>
          <div>
            ...
            <div className="space-y-2">
              {application.documents.map((doc, idx) => (
                <div key={idx} className="flex items-center justify-between p-2 hover:bg-gray-50 rounded">
                  ...
                  <a href={doc.url} className="text-blue-600 hover:underline text-sm font-medium">
                    ⬇ Download
                  </a>
                </div>
              ))}
