...
export default function AddCareerModal({ onSave, onClose, initialData = null }) {
        ...
        <div className="overflow-y-auto flex-1 p-6">
          <div className="space-y-5">
            ...
            <div className="border-t pt-5">
              <h3 className="text-base font-bold text-gray-900 mb-4">Career Paths</h3>
              <div className="space-y-3">
                {formData.careerPaths.map((path, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    <button
                      onClick={() => {
                        const newPaths = formData.careerPaths.filter((_, i) => i !== index)
                        handleChange("careerPaths", newPaths)
                      }}
                ...
                <button
                  onClick={() => handleChange("careerPaths", [...formData.careerPaths, ""])}
            ...
            <div className="border-t pt-5">
              <h3 className="text-base font-bold text-gray-900 mb-4">Employment Statistics</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange("employmentRate", e.target.value)}
                    placeholder="e.g., 95%"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleChange("graduatePlacement", e.target.value)}
                    placeholder="e.g., 25%"
                    className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
            ...
            <div className="border-t pt-5">
              <h3 className="text-base font-bold text-gray-900 mb-4">Career Services</h3>
              <div className="space-y-3">
                {formData.careerServices.map((service, index) => (
                  <div key={index} className="flex gap-2">
                    ...
                    <button
                      onClick={() => {
                        const newServices = formData.careerServices.filter((_, i) => i !== index)
                        handleChange("careerServices", newServices)
                      }}
                      className="px-3 py-2.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                    >
                ...
                <button
                  onClick={() => handleChange("careerServices", [...formData.careerServices, ""])}
                  className="w-full px-4 py-2.5 border-2 border-dashed border-gray-300 rounded-lg text-gray-600 hover:border-blue-500 hover:text-blue-600 transition-colors"
                >
                  + Add Career Service
                </button>
