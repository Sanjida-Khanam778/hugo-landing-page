...
export default function UniEventsDetails({ eventId, onBack, univId }) {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetEventsByUniIdQuery(univId);
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="flex justify-center mb-4">
                <img
                  src={
                    selectedEvent.image
                      ? getFullUrl(selectedEvent.image)
                      : eventPlaceholder
                  }
              ...
              <div
                className={`text-center p-3 rounded-lg font-bold mb-4 ${selectedEvent.status === "Upcoming" ? "bg-green/10 text-green" : "bg-gray-100 text-gray-600"}`}
              >
              ...
              <button
                onClick={
                  selectedEvent.status === "Upcoming" ? handleRegister : onBack
                }
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <p className="text-gray-600 mb-6 text-sm">
                Learn more about programs, admissions, and life at{" "}
                {selectedEvent.univ_name}.
              </p>
              <button
                onClick={onBack}
